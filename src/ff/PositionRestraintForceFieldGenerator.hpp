#ifndef POLYMER_MDMC_POSITION_RESTRAINT_FORCE_FIELD_GENERATOR_HPP
#define POLYMER_MDMC_POSITION_RESTRAINT_FORCE_FIELD_GENERATOR_HPP
...
#endif // POLYMER_MDMC_POSITION_RESTRAINT_FORCE_FIELD_GENERATOR_HPP
