#ifndef POLYMER_MDMC_MONTE_CARLO_ANISOTROPIC_BAROSTAT_GENERATOR_HPP
#define POLYMER_MDMC_MONTE_CARLO_ANISOTROPIC_BAROSTAT_GENERATOR_HPP
...
#endif // POLYMER_MDMC_MONTE_CARLO_ANISOTROPIC_BAROSTAT_GENERATOR_HPP
