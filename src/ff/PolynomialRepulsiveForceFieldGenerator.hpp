#ifndef POLYMER_MDMC_POLYNOMIAL_REPULSIVE_FORCE_FIELD_GENERATOR_HPP
#define POLYMER_MDMC_POLYNOMIAL_REPULSIVE_FORCE_FIELD_GENERATOR_HPP
...
class PolynomialRepulsiveForceFieldGenerator final : public ForceFieldGeneratorBase
{
  public:
  ...
  public:
	...
	PolynomialRepulsiveForceFieldGenerator(const double eps,
		const double cutoff, const std::vector<std::optional<double>>& radii,
	...
	std::string name() const override { return "PolynomialRepulsive"; }
...
#endif // POLYMER_MDMC_POLYNOMIAL_REPULSIVE_FORCE_FIELD_GENERATOR_HPP
