#ifndef POLYMER_MCMD_SIMULATOR_HPP
#define POLYMER_MCMD_SIMULATOR_HPP
...
class Simulator
{
	public:
		Simulator(
			...
			: Simulator(system_gen, std::move(integrator_gen_ptr), platform,
						platform_properties, total_step, save_step, observers,
